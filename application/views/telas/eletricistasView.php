...
<body>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= site_url('eletricistas') ?>">Eletricistas</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= site_url('produtos') ?>">Produtos</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= site_url('metas') ?>">Metas</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= site_url('ordemServico') ?>">Ordens de Serviço</a></li>
                    <li class="nav-item ms-3"><a class="nav-link text-danger fw-bold" href="<?= site_url('logout') ?>">Sair</a></li>
                </ul>
            </div>
        </div>
    </nav>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($ativo): ?>
                                    <a href="<?= site_url('eletricistasController/demitir/' . $eletricista['id']) ?>"
                                        class="btn btn-sm btn-outline-danger" onclick="return confirm('Demitir este funcionário?');" title="Demitir">
                                        <i class="fa-solid fa-user-minus"></i>
                                    </a>
                                <?php else: ?>
                                    <a href="<?= site_url('eletricistasController/reativar/' . $eletricista['id']) ?>"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content eletrotech-modal">
                ...
                <div class="modal-body p-4">
                    <?= form_open('eletricistasController/cadastrar', ['class' => 'eletrotech-form']) ?>
    ...
    <div class="modal fade" id="modalEditarEletricista" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content eletrotech-modal">
                ...
                <div class="modal-body p-4">
                    <?= form_open('eletricistasController/editar', ['class' => 'eletrotech-form']) ?>
    ...
    <script src="<?= base_url('node_modules/js-lib/myLibrary.js') ?>"></script>
    <script>
