        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= site_url('ordemServico') ?>">Ordens de Serviço</a></li>
                    <li class="nav-item ms-3"><a class="nav-link text-danger fw-bold" style="background-color: transparent;" href="<?= site_url('auth/logout') ?>">Sair</a></li>
                </ul>
            </div>
        </div>
    </nav>
