        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= site_url('produtos') ?>">Produtos</a></li>
                    ...
                    <?php foreach ($produtos as $produto): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= site_url('produtosController/ZerarEstoque/' . $produto['id']) ?>"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content eletrotech-modal">
                ...
                <div class="modal-body p-4">
                    <?= form_open('produtosController/cadastrar', ['class' => 'eletrotech-form']) ?>
    ...
    <div class="modal fade" id="modalEditarProduto" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content eletrotech-modal">
                ...
                <div class="modal-body p-4">
                    <?= form_open('produtosController/editar', ['class' => 'eletrotech-form']) ?>
