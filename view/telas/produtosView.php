        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="produtosView.php">Produtos</a></li>
                    ...
                    while ($produto = $resultado->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../../controllers/processaDelete.php?tabela=tabela_produtos&id=<?= $produto['id'] ?>&origem=produtosView.php"
                                    class="btn btn-sm btn-outline-danger" onclick="return confirm('Excluir estoque?');">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content eletrotech-modal">
                ...
                <div class="modal-body p-4">
                    <form action="../../controllers/processaProdutos.php" method="POST" class="eletrotech-form">
    ...
    <div class="modal fade" id="modalEditarProduto" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content eletrotech-modal">
                ...
                <div class="modal-body p-4">
                    <form action="../../controllers/processaEditProduto.php" method="POST" class="eletrotech-form">
