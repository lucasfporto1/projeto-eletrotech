    ...
    $query = "SELECT id, usuario FROM tabela_usuarios ORDER BY id DESC";
            ...
            <div class="container-fluid px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="usuariosView.php">Usuários</a></li>
                        ...
                        <?php while ($usuario = $resultado->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../../controllers/processaDelete.php?tabela=tabela_usuarios&id=<?= $usuario['id'] ?>&origem=usuariosView.php"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content eletrotech-modal">
                    ...
                    <div class="modal-body p-4">
                        <form action="../../controllers/processaEditUsuario.php" method="POST" class="eletrotech-form">
